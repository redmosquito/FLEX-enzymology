...
% 03/02/16 Drabek -- changed slash to backslash for Mac
% 11/29/16 Drabek -- Added frontslash in front of Feature_Finding line 71
...
format long e;
% if Inv == 0
      save(fullfile(pathout, ['MT_' num2str(fovn) '_Feat_Size_' num2str(featuresize)]),'MT')
% elseif Inv == 1
